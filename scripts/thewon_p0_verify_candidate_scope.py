...
def main() -> int:
    ...
    try:
        ...
        report = {"schema_version": "thewon-p0-r8-external-scope-report/v1", "base_commit": _git(args.repo, "rev-parse", args.base), "base_tree": _git(args.repo, "rev-parse", f"{args.base}^{{tree}}"), "candidate_commit": _git(args.repo, "rev-parse", "HEAD"), "candidate_tree": _git(args.repo, "rev-parse", "HEAD^{tree}"), "diff_paths": paths}
